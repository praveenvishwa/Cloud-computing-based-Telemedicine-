package com.example.chatapp.sql;
...
//import com.example.chatapp.model.Beneficiary;
import com.example.chatapp.Model.Beneficiary;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        final String SQL_CREATE_FAVORITE_TABLE = "CREATE TABLE " + BeneficiaryContract.BeneficiaryEntry.TABLE_NAME + " (" +
                ...
                BeneficiaryContract.BeneficiaryEntry.COLUMN_BENEFICIARY_AGE + " TEXT NOT NULL, " +
                BeneficiaryContract.BeneficiaryEntry.COLUMN_BENEFICIARY_GENDER + " TEXT NOT NULL, " +
                BeneficiaryContract.BeneficiaryEntry.COLUMN_BENEFICIARY_PULSERATE + " TEXT NOT NULL, " +
                BeneficiaryContract.BeneficiaryEntry.COLUMN_BENEFICIARY_WEIGHT+ " TEXT NOT NULL, " +
                BeneficiaryContract.BeneficiaryEntry.COLUMN_BENEFICIARY_HEIGHT + " TEXT NOT NULL ," +
                BeneficiaryContract.BeneficiaryEntry.COLUMN_BENEFICIARY_BLOODGRP + " TEXT NOT NULL " +
                "); ";
...
private String DROP_BENEFICIARY_TABLE = "DROP TABLE IF EXISTS " + BeneficiaryContract.BeneficiaryEntry.TABLE_NAME;
    ...
    public void addBeneficiary(Beneficiary beneficiary) {
        ...
        values.put(BeneficiaryContract.BeneficiaryEntry.COLUMN_BENEFICIARY_AGE, beneficiary.getAge());
        values.put(BeneficiaryContract.BeneficiaryEntry.COLUMN_BENEFICIARY_GENDER, beneficiary.getGender());
        values.put(BeneficiaryContract.BeneficiaryEntry.COLUMN_BENEFICIARY_PULSERATE, beneficiary.getPulserate());
        values.put(BeneficiaryContract.BeneficiaryEntry.COLUMN_BENEFICIARY_WEIGHT, beneficiary.getWeight());
        values.put(BeneficiaryContract.BeneficiaryEntry.COLUMN_BENEFICIARY_HEIGHT, beneficiary.getHeight());
        values.put(BeneficiaryContract.BeneficiaryEntry.COLUMN_BENEFICIARY_BLOODGRP, beneficiary.getBloodgrp());
    ...
    public Collection<? extends Beneficiary> getAllBeneficiary() {
        // array of columns to fetch
        String[] columns = {
                BeneficiaryContract.BeneficiaryEntry._ID,
                ...
                BeneficiaryContract.BeneficiaryEntry.COLUMN_BENEFICIARY_AGE,
                BeneficiaryContract.BeneficiaryEntry.COLUMN_BENEFICIARY_GENDER,
                BeneficiaryContract.BeneficiaryEntry.COLUMN_BENEFICIARY_PULSERATE,
                BeneficiaryContract.BeneficiaryEntry.COLUMN_BENEFICIARY_WEIGHT,
                BeneficiaryContract.BeneficiaryEntry.COLUMN_BENEFICIARY_HEIGHT,
                BeneficiaryContract.BeneficiaryEntry.COLUMN_BENEFICIARY_BLOODGRP
        };
        // sorting orders
        String sortOrder =
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                beneficiary.setAge(cursor.getString(cursor.getColumnIndex(BeneficiaryContract.BeneficiaryEntry.COLUMN_BENEFICIARY_AGE)));
                beneficiary.setGender(cursor.getString(cursor.getColumnIndex(BeneficiaryContract.BeneficiaryEntry.COLUMN_BENEFICIARY_GENDER)));
                beneficiary.setPulserate(cursor.getString(cursor.getColumnIndex(BeneficiaryContract.BeneficiaryEntry.COLUMN_BENEFICIARY_PULSERATE)));
                beneficiary.setWeight(cursor.getString(cursor.getColumnIndex(BeneficiaryContract.BeneficiaryEntry.COLUMN_BENEFICIARY_WEIGHT)));
                beneficiary.setHeight(cursor.getString(cursor.getColumnIndex(BeneficiaryContract.BeneficiaryEntry.COLUMN_BENEFICIARY_HEIGHT)));
                beneficiary.setBloodgrp(cursor.getString(cursor.getColumnIndex(BeneficiaryContract.BeneficiaryEntry.COLUMN_BENEFICIARY_BLOODGRP)));
