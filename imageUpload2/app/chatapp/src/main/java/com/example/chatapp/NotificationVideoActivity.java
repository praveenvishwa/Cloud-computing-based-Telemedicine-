...
public class NotificationVideoActivity extends AppCompatActivity {
                                                                                                        ...
                                                                                                        if(task.isSuccessful()){
                                                                                                            friendRequestRef.child(listUserId).child(currentUserId).removeValue()
                                                                                                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                                                                        ...
                                                                                                                        public void onComplete(@NonNull Task<Void> task) {
                                                                                                                            if(task.isSuccessful()){
                                                                                                                                Toast.makeText(NotificationVideoActivity.this, "New Contact saved", Toast.LENGTH_SHORT).show();
                                                                                                                            }
                                                                                                                        }
                                                                                                                    });
                                                                                                        }
                                                                ...
                                                                if(task.isSuccessful()){
                                                                    friendRequestRef.child(currentUserId).child(listUserId).removeValue()
                                                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                                ...
                                                                                public void onComplete(@NonNull Task<Void> task) {
                                                                                    if(task.isSuccessful()){
                                                                                        Toast.makeText(NotificationVideoActivity.this, "Friend Request Cancelled", Toast.LENGTH_SHORT).show();
                                                                                    }
                                                                                }
                                                                            });
                                                                }
